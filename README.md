...
| develpoment             | Classificação de desenvolvimento de acordo com o \ac{HDRO}: \textit{Very high human development}, \textit{High human development}, \textit{Medium human development} ou \textit{Low human development}.                                                   |
| idh                     | \ac{IDH} de um país no ano indicado pela coluna year.                                                                                                                                                                                                     |
